...
class SelectConstructor {
	...
	selectInit(originalSelect, index) {
		...
		if (!originalSelect.hasAttribute('data-fade-select')) {
			selectItem.insertAdjacentHTML('beforeend', `<div class="${this.selectClasses.classSelectBody}"><div hidden class="${this.selectClasses.classSelectOptions}"></div></div>`);
		} else {
			selectItem.insertAdjacentHTML('beforeend', `<div class="${this.selectClasses.classSelectBody}"><div class="${this.selectClasses.classSelectOptions} ${this.selectClasses.classSelectOptionsFade}"></div></div>`);
		}
	...
	selectСlose(selectItem) {
		...
		if (!selectOptions.classList.contains('_slide')) {
			...
			if(!selectOptions.classList.contains('select__fade')){
