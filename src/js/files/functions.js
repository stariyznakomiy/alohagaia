	...
	if (spollersArray.length > 0) {
				...
				spollerTitles.forEach(spollerTitle => {
					if (hideSpollerBody) {
						...
						if (!spollerTitle.classList.contains('_spoller-active')) {
							if (!spollerTitle.hasAttribute('data-spoller-fade')) {
		...
		function hideSpollersBody(spollersBlock) {
			...
			if (spollerActiveTitle && !spollersBlock.querySelectorAll('._slide').length) {
				...
				if (!spollerActiveTitle.hasAttribute('data-spoller-fade')) {
				...
				if (!el.closest('[data-spollers]')) {
					spollersClose.forEach(spollerClose => {
						...
						if (spollersBlock.classList.contains('_spoller-init')) {
							...
							if (!spollerClose.hasAttribute('data-spoller-fade')) {
...
export function searchInit() {
	if (document.querySelector(".icon-search")) {
		document.addEventListener("click", function (e) {
			if (bodyLockStatus && e.target.closest('.icon-search')) {
	...
	if (document.querySelector(".search-close")) {
		document.addEventListener("click", function (e) {
